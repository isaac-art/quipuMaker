...
public class talkingKnots extends PApplet {
...
public void printMemoryTapeToConsole(int memTapeNum){
...
// 	}
// }
  public void settings() { 	size(960, 540); 	smooth(0); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "talkingKnots" };
    if (passedArgs != null) {
